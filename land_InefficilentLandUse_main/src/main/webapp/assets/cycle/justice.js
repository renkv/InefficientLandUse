...
layui.use(['table', 'admin','laydate','tableMerge', 'ax', 'func','upload'], function () {
    ...
    detailMainTable.initColumn = function () {
        return [[
            ...
            {field: 'pqbh', sort: false,align: 'center',merge:true,fixed: 'left',hide: true, title: '片区编号'},
            ...
            {field: 'xzyt', sort: false, align: 'center', merge:true,title: '现状用途'},
            {field: 'ghyt', sort: false, align: 'center',hide: true,title: '规划用途'},
            {field: 'zkfsx', sort: false, align: 'center',title: '再开发时序'},
            {field: 'remark', sort: false, align: 'center',title: '备注'},

            // {field: 'jbqk', sort: false, align: 'center',title: '基本情况'},
            // {field: 'dktj', sort: false, align: 'center',title: '地块推介'},

            {field: 'createUserName',hide: true, sort: false,align: 'center', hide: true,title: '创建人名字'},
            {field: 'createTime', hide: true,sort: false,align: 'center',hide: true, title: '创建时间'},
            {field: 'updateUserName', hide: true,sort: false,align: 'center', hide: true,title: '修改人名字'},
            {field: 'updateTime', hide: true,sort: false,align: 'center', hide: true,title: '修改时间'}
    ...
    var tableResult = table.render({
        ...
        url: Feng.ctxPath + '/cycle/selectListByStatus?status=5',
        page: true,
        height: "full-158",
        cellMinWidth: 100,
    ...
    detailMainTable.openAddPage = function () {
        func.open({
            ...
            width:'1500px',
            title: '新增自主开发项目',
            content: Feng.ctxPath + '/cycle/add?landStatus=5',
            tableId: detailMainTable.tableId,
            endCallback: function () {
                table.reload(detailMainTable.tableId);
            }
