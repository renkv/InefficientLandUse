...
layui.use(['table', 'admin','laydate','tableMerge', 'ax', 'func','upload'], function () {
    ...
    detailMainTable.initColumn = function () {
        return [[
            ...
            {field: 'ghyt', sort: false, align: 'center', merge:true,title: '规划用途'},
            ...
            {field: 'tsfabz',  hide: true,sort: false, align: 'center',title: '提升方案编制'},
            {field: 'tsfass', hide: true, sort: false, align: 'center',title: '提升方案实施'},
            {field: 'tscxzm', hide: true, sort: false, align: 'center',title: '提升成效证明'},
