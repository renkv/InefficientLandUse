...
layui.use(['table', 'admin','laydate','tableMerge', 'ax', 'func','upload'], function () {
    ...
    detailMainTable.initColumn = function () {
        return [[
            ...
            {field: 'pqbh', sort: false,hide: true,align: 'center',merge:true,fixed: 'left', title: '片区编号'},
            ...
            {field: 'createUserName', sort: false,align: 'center',hide: true, title: '创建人名字'},
            {field: 'createTime', sort: false,align: 'center',hide: true, title: '创建时间'},
            {field: 'updateUserName', sort: false,align: 'center',hide: true, title: '修改人名字'},
            {field: 'updateTime', sort: false,align: 'center',hide: true, title: '修改时间'}
