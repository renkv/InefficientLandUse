...
layui.use(['table', 'admin','tableMerge',  'laydate','ax', 'func'], function () {
    ...
    busMainTable.initColumn = function () {
        return [[
            ...
            {field: 'zoneName', sort: false, align: 'center',title: '开发区低效处置项目名称',templet:function (d){
                    var html = '<div><a rel="nofollow"  style="color:#1E9FFF" href="javascript:void(0);" lay-event="showDetail">' + d.zoneName+ '</a></div>';
                    return html;
                }
                },
    ...
    busMainTable.search = function () {
        ...
        queryData['zoneName'] = $('#zoneName').val();
