...
layui.use(['table', 'admin','tableMerge',  'laydate','ax', 'func'], function () {
    ...
    busMainTable.initColumn = function () {
        return [[
            ...
            {field: 'villageName', sort: false, align: 'center',title: '城中村名称',templet:function (d){
            var html = '<div><a rel="nofollow"  style="color:#1E9FFF" href="javascript:void(0);" lay-event="showDetail">' + d.villageName+ '</a></div>';
            return html;
        }},
    ...
    var tableResult = table.render({
        ...
        url: Feng.ctxPath + '/plan/selectList?planType=2',
        page: true,
        height: "full-158",
        cellMinWidth: 100,
    ...
    busMainTable.search = function () {
        ...
        queryData['villageName'] = $('#villageName').val();
    ...
    busMainTable.openAddPage = function () {
        func.open({
            ...
            height: 1500,
            title: '新增城中村改造计划信息',
            content: Feng.ctxPath + '/plan/add?planType=2',
            tableId: busMainTable.tableId,
            endCallback: function () {
                table.reload(busMainTable.tableId);
            }
