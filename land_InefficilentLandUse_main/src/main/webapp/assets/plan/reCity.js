...
layui.use(['table', 'admin','tableMerge',  'laydate','ax', 'func'], function () {
    ...
    busMainTable.initColumn = function () {
        return [[
            ...
            {field: 'renewalName', sort: false, align: 'center',title: '城市更新项目名称',templet:function (d){
                    var html = '<div><a rel="nofollow"  style="color:#1E9FFF" href="javascript:void(0);" lay-event="showDetail">' + d.renewalName+ '</a></div>';
                    return html;
                }
                },
    ...
    var tableResult = table.render({
        ...
        url: Feng.ctxPath + '/plan/selectList?planType=3',
        page: true,
        height: "full-158",
        cellMinWidth: 100,
    ...
    busMainTable.search = function () {
        ...
        queryData['renewalName'] = $('#renewalName').val();
    ...
    busMainTable.openAddPage = function () {
        func.open({
            ...
            height: 1500,
            title: '新增城市更新计划信息',
            content: Feng.ctxPath + '/plan/add?planType=3',
            tableId: busMainTable.tableId,
            endCallback: function () {
                table.reload(busMainTable.tableId);
            }
