...
@Data
@TableName("land_detail_info_his")
public class LandDetailInfoHis {
    ...
    @Basic
    @Column(name = "op_user", nullable = true)
    private Long opUser;
    @Basic
    @Column(name = "op_user_name", nullable = true, length = 20)
    private String opUserName;
    @Basic
    @Column(name = "op_time", nullable = true)
    private Date opTime;
    @Basic
    @Column(name = "op_status", nullable = true, length = 20)
