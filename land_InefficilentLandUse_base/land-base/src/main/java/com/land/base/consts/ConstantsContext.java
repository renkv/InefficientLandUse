package com.land.base.consts;

import cn.stylefeng.roses.core.util.ToolUtil;
import com.land.base.enums.CommonStatus;
import com.land.base.sms.AliyunSmsProperties;
...
import static com.land.base.consts.ConfigConstant.SYSTEM_CONSTANT_PREFIX;
...
public class ConstantsContext {
     ...
     * 获取管理系统名称
     */
    public static String getExportExcelTemplate() {
        String exportExcelTemplate = (String) CONSTNTS_HOLDER.get("LAND_EXPORT_EXCEL_TEMPLATE");
        if (ToolUtil.isEmpty(exportExcelTemplate)) {
            log.error("系统常量存在空值！常量名称：LAND_EXPORT_EXCEL_TEMPLATE" + TIPS_END);
            return "";
        } else {
