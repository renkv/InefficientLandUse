...
import com.land.base.tenant.entity.TenantInfo;
import com.land.base.tenant.service.TenantInfoService;
...
public class LoginController extends BaseController {
    ...
    public ResponseData loginVali(HttpServletRequest request, HttpServletResponse response) {
        ...
        password = Base64Util.decodeBase64(password,3);
        ...
        if (ConstantsContext.getKaptchaOpen()) {
            String kaptcha = super.getPara("code").trim();
            String code = (String) super.getSession().getAttribute(Constants.KAPTCHA_SESSION_KEY);
            //String code = (String) super.getSession().getAttribute("AdminCode");
