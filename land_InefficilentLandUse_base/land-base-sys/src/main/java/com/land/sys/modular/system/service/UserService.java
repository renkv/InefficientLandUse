...
import com.land.base.oauth2.entity.OauthUserInfo;
import com.land.base.oauth2.service.OauthUserInfoService;
import com.land.base.pojo.node.MenuNode;
import com.land.base.pojo.page.LayuiPageFactory;
import com.land.sys.core.constant.Const;
import com.land.sys.core.constant.factory.ConstantFactory;
import com.land.sys.core.constant.state.ManagerStatus;
...
import com.land.sys.modular.system.entity.UserPos;
...
public class UserService extends ServiceImpl<UserMapper, User> {
    ...
    public Page<Map<String, Object>> getSelectUsers(DataScope dataScope, String name, String beginTime, String endTime, Long deptId) {
        Page page = LayuiPageFactory.defaultPage();
        Long userId = LoginContextHolder.getContext().getUser().getId();
        return this.baseMapper.getSelectUsers(page, dataScope, name, beginTime, endTime, deptId,userId);
    }
}
