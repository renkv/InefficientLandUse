...
import com.land.auth.annotion.Permission;
...
import com.land.sys.core.constant.dictmap.UserDict;
...
public class UserMgrController extends BaseController {
    ...
    public String userSelect(@RequestParam("formName") String formName,
                             @RequestParam("formId") String formId,
                             @RequestParam("userIds") String userIds, Model model) {
    ...
    @ResponseBody
    public Object selectList(@RequestParam(required = false) String name,
                       @RequestParam(required = false) String timeLimit,
                       @RequestParam(required = false) Long deptId) {
        ...
        Page<Map<String, Object>> users = userService.getSelectUsers(null, name, beginTime, endTime, deptId);
        Page wrapped = new UserWrapper(users).wrap();
        return LayuiPageFactory.createPageInfo(wrapped);
    }
